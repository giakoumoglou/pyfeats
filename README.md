...
* _mask_ is an image as a numpy ndarray but with 2 values: 0 (zero) and 1 (one) where 1 indicates the ROI, where the features shall be calculated (values outside ROI are ignored),
